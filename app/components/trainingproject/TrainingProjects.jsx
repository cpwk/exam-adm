...
export default class TrainingProjects extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
    ...
    loadData = () => {
        ...
        App.api('adm/trainingProject/trainingProjects', {
            trainingProjectQo: JSON.stringify({
    ...
    remove = (id, index) => {
        ...
        Modal.confirm({
            title: `确认删除操作?`,
            onOk() {
                App.api('adm/trainingProject/remove', {id}).then(() => {
    ...
    edit = (id) => {
        App.go(`/app/ws/training-project-edit/${id}`);
    };
    ...
    render() {
        ...
        return <div className="common-list">
            ...
            <BreadcrumbCustom first={CTYPE.link.ws_training_projects.txt}/>
            ...
            <Card bordered={false}>
                ...
                <Table columns={[{
                    ...
                    className: 'txt-center',
                    width: '80px',
                    render: (obj, trainingProject, index) => {

                        return <Dropdown overlay={<Menu>
                            <Menu.Item key="1">
                                <a onClick={() => this.edit(trainingProject.id)}>编辑</a>
                            </Menu.Item>
                            <Menu.Divider/>
                            <Menu.Item key="2">
                                <a onClick={() => this.remove(trainingProject.id, index)}>删除</a>
                            </Menu.Item>
                        </Menu>} trigger={['click']}>
