...
export default class TraineeSessions extends React.Component {
    ...
    loadData = () => {
        ...
        let {traineeId, pagination = {}} = this.state;

        Utils.nProgress.start();
        App.api('adm/trainee/traineeSessions', {
            traineeSessionQo: JSON.stringify({
                traineeId,
