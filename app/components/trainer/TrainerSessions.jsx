...
export default class TrainerSessions extends React.Component {
    ...
    loadData = () => {
        ...
        let {trainerId, pagination = {}} = this.state;

        Utils.nProgress.start();
        App.api('adm/trainer/trainerSessions', {
            trainerSessionQo: JSON.stringify({
                trainerId,
